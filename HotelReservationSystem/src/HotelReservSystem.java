...
public class HotelReservSystem {
    ...
    public static void main(String[] args) throws ClassNotFoundException,SQLException{
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");//connection established with mysql
        ...
        try{
            Connection connection= DriverManager.getConnection(url,username,password);//connect with database mysql
            while(true){
                System.out.println();
...
public static boolean reservationExists(Connection connection, int reservationId){
        try{
            ...
            try(Statement statement= connection.createStatement(); ResultSet resultSet= statement.executeQuery(sql)){
                return resultSet.next();//of there's a resut , the reservation exists

            }

        }catch (SQLException e){
            e.printStackTrace();
            return false;//handle database erros as needed
        }
